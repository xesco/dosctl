...
class TestIntegration:
    ...
    def test_game_installation_workflow(self, mock_installed_dir, mock_downloads_dir):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            mock_downloads_dir.return_value = downloads_dir
            mock_installed_dir.return_value = installed_dir
            ...
            zip_path = downloads_dir / "TestGame.zip"
    ...
    @patch('dosctl.config.DOWNLOADS_DIR')
    @patch('dosctl.config.INSTALLED_DIR')
    def test_error_handling_workflow(self, mock_installed_dir, mock_downloads_dir):
    ...
    @patch('dosctl.config.DOWNLOADS_DIR')
    def test_collection_download_integration(self, mock_downloads_dir):
